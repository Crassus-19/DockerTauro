...
// 🟢 Obtener órdenes activas de "Rancho San Antonio"
$sql_ordenes = "SELECT o.ID, v.Nombre AS Unidad, o.Descripcion, o.Estado, o.Fecha, 
                ...
                AND v.Asignacion = 'rancho_san_antonio'
...
<head>
    ...
    <title>Órdenes Activas - Rancho San Antonio</title>
    ...
    <div class="container my-5">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="4" class="text-center text-danger">No hay órdenes activas para Rancho San Antonio</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
